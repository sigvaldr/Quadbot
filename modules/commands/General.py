...
class General(commands.Cog):
    ...
    @nextcord.slash_command(name="fuck", description="testme", guild_ids=[VTAC])
    async def fuck(self, interaction:Interaction):
        await interaction.response.send_message(":middlefinger:")
